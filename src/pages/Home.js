      ...
      <nav class="flex items-center justify-between flex-wrap bg-white p-6">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div class="text-sm lg:flex-grow text-right mx-3">
            <a
              href="/home"
              class="block mt-4 lg:inline-block lg:mt-0 text-black-200 hover:text-blue-500 hover:underline underline-offset-12 mr-4"
            >
              Home
            </a>
            <a
              href="/about"
              class="block mt-4 lg:inline-block lg:mt-0 text-black-200 hover:text-blue-500 mr-4"
            >
              About
            </a>
            <a
            ...
            <a
              href="#responsive-header"
              class="block mt-4 lg:inline-block lg:mt-0 text-black-200 hover:text-blue-500"
            >
              Contact
            </a>
          </div>
